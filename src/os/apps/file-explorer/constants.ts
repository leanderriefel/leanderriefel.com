...
import { HomeIcon, FolderIcon, FileTextIcon, ImageIcon, Music2Icon, VideoIcon, DownloadIcon } from "lucide-solid"
import type { QuickAccessItem } from "./types"

export const QUICK_ACCESS: QuickAccessItem[] = [
  { name: "Home", path: "/" as FsPath, icon: HomeIcon },
  { name: "Desktop", path: "/Desktop" as FsPath, icon: FolderIcon },
